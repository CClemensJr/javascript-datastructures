...
------------------------------------------------------------------------------------------------ */
// Obtained inspiration from https://scriptverse.academy/tutorials/js-array-map.html
...
const extractStats = (arr) => arr.map(statObj => ({ 'name': statObj.stat.name, 'total': statObj.effort + statObj.baseStat }));
